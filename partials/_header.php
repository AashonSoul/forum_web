...
<a class="navbar-brand" href="/forum_web">Lilliput</a>
...
<div class="collapse navbar-collapse" id="navbarSupportedContent">
  <ul class="navbar-nav mr-auto">
    <li class="nav-item active"> 
      <a class="nav-link" href="/forum_web">Home <span class="sr-only">(current)</span></a>
    </li>
    <li class="nav-item">
  ...
  if(isset($_SESSION['loggedin']) && $_SESSION['loggedin']==true){
    ...
    <div class="mx-3">
        ...
        <button class="btn btn-outline-success" data-toggle="modal" data-target="#singupModal">Signup</button>
    </div>';
  }
